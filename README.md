# TechBlog
# A Model-View-Controller (MVC) application 
https://pacific-wildwood-64828.herokuapp.com/

# Project Description
This tool is an application that allows you to create an account, login, post new blog posts, delete your own blog posts and save them. You can also comment on others blog posts.  

# Usage Information
Click the login page, sign up for an account. Once signed in you'll be able to follow the prompts to submit a new post and title. You can delete your posts by clicking on the delete button
